...
const FeaturedPost: React.FC<FeaturedPostProps> = ({
	...
	return (
		<Link href={'/posts/' + slug}>
			<Card
				isBlurred
				className="border-none bg-background/60 h-[204px] dark:bg-default-100/50"
				shadow="sm"
			>
				<CardBody>
					<div className=" h-[204px] grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center">
